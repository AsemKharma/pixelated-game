...
class Level4 extends Phaser.Scene {
    ...
    update() {
        ...
        // }else if (cond==false && (timer%1024==0)){
        //     wizard.anims.play('attackwiz', true);
...
class Level5 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('spike', './assetsLevel1/spikePatch.png')
        this.load.image('floor', './assetsLevel1/floor.png')
        this.load.image('movingSurface', './assetsLevel1/movingSurface.png')
        this.load.image('movingChangeSpots', './assetsLevel1/movingChangeSpots.png')
        this.load.image('pressurePlate', './assetsLevel1/PressurePlates.png')
        this.load.image('block1', './assetsLevel1/Block1.png')
        this.load.image('block2', './assetsLevel1/Block2.png')
        this.load.image('block3', './assetsLevel1/Block3.png')
        this.load.image('block1Surface', './assetsLevel1/Block1Surface.png')
        this.load.image('block2Surface', './assetsLevel1/Block2Surface.png')
        this.load.image('block3Surface', './assetsLevel1/Block3Surface.png')
    }
    create() {
        this.add.image(0, 0, 'lv1layer1').setOrigin(0).setScale(6);
        this.sound.play('forest', { loop: true });
